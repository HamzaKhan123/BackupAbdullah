                ...
                // new comment
                    ...
                    StringRequest sr = new StringRequest(Request.Method.POST,postuser, new Response.Listener<String>() {
                        ...
                        protected Map<String,String> getParams(){
                            ...
                            params.put("username",username_);//done
                            params.put("password",pass_);//done
                            params.put("is_active","1");//done
                            params.put("email",user_e);//done

                            String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
                            params.put("date_added",timeStamp);//done
                            params.put("filename",user_e+".jpeg");//done


                            String first="",last="";
                            StringTokenizer st = new StringTokenizer(username_);
                            int i=0,count=0;
                            ...
                            params.put("categories",categories_);//done
